...
def get_activations(args, files, model, batch_size=50, dims=2048, device='cpu'):
...
def calculate_activation_statistics(files, model, batch_size=50, dims=2048,
    ...
    #np.savez("./cor_celeba_64.train.npz", mu=mu, sigma=sigma)
    return mu, sigma
...
def compute_statistics_of_path(path, model, batch_size, dims, device):
    if path.endswith('.npz'):
        ...
        #m, s = calculate_activation_statistics(files, model, batch_size, dims, device)#################modified
